...
className={px-3 py-2 rounded-md text-sm font-medium transition-colors ${ activePage === page ? 'text-primary bg-blue-100' : 'text-text-secondary hover:text-primary hover:bg-gray-100' }}
>
{label}
</button>
</li>
