...
import AuditLogPage from './admin/AuditLogPage'; // Import
...
// ... (Mock Data & RiskBadge component same as before) ...
...
const AdminDashboardPage: React.FC<AdminDashboardPageProps> = ({ onLogout, userRole }) => {
  ...
  const renderContent = () => {
    switch(activePage) {
      ...
      case 'audit': return <AuditLogPage userRole={userRole} />; // ENABLED
