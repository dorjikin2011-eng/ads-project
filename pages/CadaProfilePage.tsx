// pages/CadaProfilePage.tsx
// ------------------------------------------------------------
// COPY OF DECLARANT'S PROFILE PAGE ADAPTED FOR CADA
// ------------------------------------------------------------
...
const initialProfileData: ProfileData = {
  personal: {
    ...
    officialId: 'CADA-2023-001',
    dob: '1978-11-25',
    email: 'tashi.d@acc.gov.bt',
    phone: '02-337423',
  },
  agency: {
    name: 'Anti-Corruption Commission',
    department: 'Asset Declaration Management Division',
    position: 'Central Asset Declaration Administrator',
  ...
  family: [
    { id: '1', name: 'Choden Wangmo', relationship: 'Spouse', occupation: 'Legal Advisor' },
    { id: '2', name: 'Jigme Norbu', relationship: 'Son', occupation: 'University Student' },
    { id: '3', name: 'Karma Yangchen', relationship: 'Daughter', occupation: 'Medical Student' },
  ],
  assets: [],
  liabilities: [],
  expenditures: [],
...
const CadaProfilePage: React.FC<Props> = ({ profilePicture, setProfilePicture }) => {
  ...
  return (
    <div>
      {/* CHANGED: Updated title to indicate CADA */}
      <h1 className="text-3xl font-bold text-text-main mb-2">Your Profile - Central Asset Declaration Administrator</h1>
      ...
      <div className="space-y-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 flex items-center space-x-6">
          ...
          <div>
            ...
            {/* CHANGED: Added CADA indicator */}
            <p className="text-sm text-primary font-medium">Central ADA - Anti-Corruption Commission</p>
          </div>
        </div>
...
export default CadaProfilePage;