...
const FileNewPage: React.FC<FileNewPageProps> = ({ isProcessingForAdmin = false, targetOfficialName, targetOfficialId }) => {
    ...
    const handleChange = (setter: any, id: string, field: string, value: string) => { setter((prev: any) => prev.map((i: any) => i.id === id ? { ...i, [field]: value } : i)); };
    ...
    const renderImmovable = () => ( <div> <SectionHeader title="Immovable Properties" subtitle="Land, Building, House, Flat (Sec 6.1)" /> {immovable.map(item => ( <ItemCard key={item.id} title={`${item.type} - ${item.thramNo}`} onRemove={() => handleRemove(setImmovable, item.id)}> <FormSelect label="Owner" value={item.ownerRelationship} onChange={(e:any) => handleChange(setImmovable, item.id, 'ownerRelationship', e.target.value)}>{getRelationOptions()}</FormSelect> <FormSelect label="Type" value={item.type} onChange={(e:any) => handleChange(setImmovable, item.id, 'type', e.target.value)}><option>Land</option><option>Building</option><option>Flat</option><option>House</option></FormSelect> <FormInput label="Thram / Plot / House No" value={item.thramNo} onChange={(e:any) => handleChange(setImmovable, item.id, 'thramNo', e.target.value)} /> <FormInput label="Size / Qty" value={item.size} onChange={(e:any) => handleChange(setImmovable, item.id, 'size', e.target.value)} /> <FormInput label="Location" value={item.location} onChange={(e:any) => handleChange(setImmovable, item.id, 'location', e.target.value)} /> <FormInput label="Date of Acquisition" type="date" value={item.acquisitionDate} onChange={(e:any) => handleChange(setImmovable, item.id, 'acquisitionDate', e.target.value)} /> <FormInput label="Mode of Acquisition" placeholder="Purchase, Gift, Inheritance" value={item.acquisitionMode} onChange={(e:any) => handleChange(setImmovable, item.id, 'acquisitionMode', e.target.value)} /> <FormInput label="Cost (Nu.)" type="number" value={item.cost} onChange={(e:any) => handleChange(setImmovable, item.id, 'cost', e.target.value)} /> <FormInput label="Source of Finance" value={item.sourceOfFinance} onChange={(e:any) => handleChange(setImmovable, item.id, 'sourceOfFinance', e.target.value)} /> <FormInput label="Acquired From (Name & CID)" value={item.acquiredFrom} onChange={(e:any) => handleChange(setImmovable, item.id, 'acquiredFrom', e.target.value)} /> <FormInput label="Registered Owner Name/CID" value={item.registeredOwner} onChange={(e:any) => handleChange(setImmovable, item.id, 'registeredOwner', e.target.value)} /> <div className="md:col-span-3"><FileUpload documents={item.documents} onFileChange={(e) => handleFile(setImmovable, item.id, e)} onFileRemove={(fid) => handleFileRemove(setImmovable, item.id, fid)} /></div> </ItemCard> ))} <button onClick={() => handleAdd(setImmovable, {type: 'Land', ownerRelationship: 'Self'})} className="flex items-center text-primary font-bold text-sm"><PlusIcon className="w-5 h-5 mr-1" /> Add Property</button> </div> );
    const renderMovable = () => ( <div className="space-y-8"> <div> <SectionHeader title="Shares and Stocks" subtitle="Sec 6.2" /> {shares.map(item => ( <ItemCard key={item.id} title={`Shares in ${item.company}`} onRemove={() => handleRemove(setShares, item.id)}> <FormSelect label="Owner" value={item.ownerRelationship} onChange={(e:any) => handleChange(setShares, item.id, 'ownerRelationship', e.target.value)}>{getRelationOptions()}</FormSelect> <FormInput label="Company" value={item.company} onChange={(e:any) => handleChange(setShares, item.id, 'company', e.target.value)} /> <FormInput label="Num of Shares" value={item.numberOfShares} onChange={(e:any) => handleChange(setShares, item.id, 'numberOfShares', e.target.value)} /> <FormInput label="Total Cost (Nu.)" value={item.cost} onChange={(e:any) => handleChange(setShares, item.id, 'cost', e.target.value)} /> <div className="md:col-span-3"><FileUpload documents={item.documents} onFileChange={(e) => handleFile(setShares, item.id, e)} onFileRemove={(fid) => handleFileRemove(setShares, item.id, fid)} /></div> </ItemCard> ))} <button onClick={() => handleAdd(setShares, {ownerRelationship: 'Self'})} className="flex items-center text-primary font-bold text-sm"><PlusIcon className="w-5 h-5 mr-1" /> Add Shares</button> </div> <div> <SectionHeader title="Vehicles and Machineries" subtitle="Sec 6.3" /> {vehicles.map(item => ( <ItemCard key={item.id} title={`${item.make} ${item.model}`} onRemove={() => handleRemove(setVehicles, item.id)}> <FormSelect label="Owner" value={item.ownerRelationship} onChange={(e:any) => handleChange(setVehicles, item.id, 'ownerRelationship', e.target.value)}>{getRelationOptions()}</FormSelect> <FormInput label="Type" value={item.type} onChange={(e:any) => handleChange(setVehicles, item.id, 'type', e.target.value)} /> <FormInput label="Registration No." value={item.registrationNo} onChange={(e:any) => handleChange(setVehicles, item.id, 'registrationNo', e.target.value)} /> <FormInput label="Make/Model" value={item.model} onChange={(e:any) => handleChange(setVehicles, item.id, 'model', e.target.value)} /> <FormInput label="Cost (Nu.)" value={item.cost} onChange={(e:any) => handleChange(setVehicles, item.id, 'cost', e.target.value)} /> <div className="md:col-span-3"><FileUpload documents={item.documents} onFileChange={(e) => handleFile(setVehicles, item.id, e)} onFileRemove={(fid) => handleFileRemove(setVehicles, item.id, fid)} /></div> </ItemCard> ))} <button onClick={() => handleAdd(setVehicles, {ownerRelationship: 'Self', type: 'Vehicle'})} className="flex items-center text-primary font-bold text-sm"><PlusIcon className="w-5 h-5 mr-1" /> Add Vehicle</button> </div> </div> );
    const renderOtherAssets = () => ( <div className="space-y-8"> <div> <SectionHeader title="Virtual Assets" subtitle="Bitcoin, Litecoin, Ether etc (Sec 6.4)" /> {virtual.map(item => ( <ItemCard key={item.id} title={item.type} onRemove={() => handleRemove(setVirtual, item.id)}> <FormSelect label="Owner" value={item.ownerRelationship} onChange={(e:any) => handleChange(setVirtual, item.id, 'ownerRelationship', e.target.value)}>{getRelationOptions()}</FormSelect> <FormInput label="Type" value={item.type} onChange={(e:any) => handleChange(setVirtual, item.id, 'type', e.target.value)} /> <FormInput label="Quantity" value={item.qty} onChange={(e:any) => handleChange(setVirtual, item.id, 'qty', e.target.value)} /> <FormInput label="Cost (Nu.)" value={item.cost} onChange={(e:any) => handleChange(setVirtual, item.id, 'cost', e.target.value)} /> </ItemCard> ))} <button onClick={() => handleAdd(setVirtual, {ownerRelationship: 'Self'})} className="flex items-center text-primary font-bold text-sm"><PlusIcon className="w-5 h-5 mr-1" /> Add Virtual Asset</button> </div> <div> <SectionHeader title="Personal Savings" subtitle="Bank deposits, Cash in hand > 1 month salary (Sec 6.5)" /> {savings.map(item => ( <ItemCard key={item.id} title={`${item.bankName} - ${item.balance}`} onRemove={() => handleRemove(setSavings, item.id)}> <FormSelect label="Owner" value={item.ownerRelationship} onChange={(e:any) => handleChange(setSavings, item.id, 'ownerRelationship', e.target.value)}>{getRelationOptions()}</FormSelect> <FormSelect label="Type" value={item.type} onChange={(e:any) => handleChange(setSavings, item.id, 'type', e.target.value)}><option>Bank Deposit</option><option>Cash in Hand</option><option>Money Lent</option></FormSelect> <FormInput label="Bank Name" value={item.bankName} onChange={(e:any) => handleChange(setSavings, item.id, 'bankName', e.target.value)} /> <FormInput label="Account No" value={item.accountNumber} onChange={(e:any) => handleChange(setSavings, item.id, 'accountNumber', e.target.value)} /> <FormInput label="Balance (Nu.)" value={item.balance} onChange={(e:any) => handleChange(setSavings, item.id, 'balance', e.target.value)} /> <div className="md:col-span-3"><FileUpload documents={item.documents} onFileChange={(e) => handleFile(setSavings, item.id, e)} onFileRemove={(fid) => handleFileRemove(setSavings, item.id, fid)} /></div> </ItemCard> ))} <button onClick={() => handleAdd(setSavings, {ownerRelationship: 'Self', type: 'Bank Deposit'})} className="flex items-center text-primary font-bold text-sm"><PlusIcon className="w-5 h-5 mr-1" /> Add Saving</button> </div> <div> <SectionHeader title="Convertible Assets" subtitle="Jewelry, Gold, Art > Nu. 100,000 (Sec 6.6)" /> {convertible.map(item => ( <ItemCard key={item.id} title={item.type} onRemove={() => handleRemove(setConvertible, item.id)}> <FormSelect label="Owner" value={item.ownerRelationship} onChange={(e:any) => handleChange(setConvertible, item.id, 'ownerRelationship', e.target.value)}>{getRelationOptions()}</FormSelect> <FormInput label="Type/Description" value={item.type} onChange={(e:any) => handleChange(setConvertible, item.id, 'type', e.target.value)} /> <FormInput label="Cost (Nu.)" value={item.cost} onChange={(e:any) => handleChange(setConvertible, item.id, 'cost', e.target.value)} /> </ItemCard> ))} <button onClick={() => handleAdd(setConvertible, {ownerRelationship: 'Self'})} className="flex items-center text-primary font-bold text-sm"><PlusIcon className="w-5 h-5 mr-1" /> Add Convertible Asset</button> </div> </div> );
    const renderIncomeLiability = () => ( <div className="space-y-8"> <div> <SectionHeader title="Income Statement" subtitle="Sources of all income (Annual Gross) (Sec 6.8)" /> {income.map(item => ( <ItemCard key={item.id} title={`${item.ownerRelationship} Income`} onRemove={() => handleRemove(setIncome, item.id)}> <FormSelect label="Earner" value={item.ownerRelationship} onChange={(e:any) => handleChange(setIncome, item.id, 'ownerRelationship', e.target.value)}>{getRelationOptions()}</FormSelect> <FormInput label="Gross Salary" type="number" value={item.salary} onChange={(e:any) => handleChange(setIncome, item.id, 'salary', e.target.value)} /> <FormInput label="Business/Consultancy" type="number" value={item.business} onChange={(e:any) => handleChange(setIncome, item.id, 'business', e.target.value)} /> <FormInput label="Rental" type="number" value={item.rental} onChange={(e:any) => handleChange(setIncome, item.id, 'rental', e.target.value)} /> <FormInput label="Dividends" type="number" value={item.dividends} onChange={(e:any) => handleChange(setIncome, item.id, 'dividends', e.target.value)} /> <FormInput label="Others" type="number" value={item.others} onChange={(e:any) => handleChange(setIncome, item.id, 'others', e.target.value)} /> <div className="md:col-span-3"><FileUpload documents={item.documents} onFileChange={(e) => handleFile(setIncome, item.id, e)} onFileRemove={(fid) => handleFileRemove(setIncome, item.id, fid)} /></div> </ItemCard> ))} <button onClick={() => handleAdd(setIncome, {ownerRelationship: 'Self'})} className="flex items-center text-primary font-bold text-sm"><PlusIcon className="w-5 h-5 mr-1" /> Add Income Source</button> </div> <div> <SectionHeader title="Liabilities" subtitle="Loans and Borrowings (Sec 6.9)" /> {liabilities.map(item => ( <ItemCard key={item.id} title={`${item.type} - ${item.lenderDetails}`} onRemove={() => handleRemove(setLiabilities, item.id)}> <FormSelect label="Borrower" value={item.ownerRelationship} onChange={(e:any) => handleChange(setLiabilities, item.id, 'ownerRelationship', e.target.value)}>{getRelationOptions()}</FormSelect> <FormSelect label="Type" value={item.type} onChange={(e:any) => handleChange(setLiabilities, item.id, 'type', e.target.value)}><option>Bank Loan</option><option>Private Borrowing</option></FormSelect> <FormInput label="Sanctioned Amount" value={item.sanctionedAmount} onChange={(e:any) => handleChange(setLiabilities, item.id, 'sanctionedAmount', e.target.value)} /> <FormInput label="Lender Name/Bank" value={item.lenderDetails} onChange={(e:any) => handleChange(setLiabilities, item.id, 'lenderDetails', e.target.value)} /> <FormInput label="Date Borrowed" type="date" value={item.borrowingDate} onChange={(e:any) => handleChange(setLiabilities, item.id, 'borrowingDate', e.target.value)} /> <div className="md:col-span-3"><FileUpload documents={item.documents} onFileChange={(e) => handleFile(setLiabilities, item.id, e)} onFileRemove={(fid) => handleFileRemove(setLiabilities, item.id, fid)} /></div> </ItemCard> ))} <button onClick={() => handleAdd(setLiabilities, {ownerRelationship: 'Self', type: 'Bank Loan'})} className="flex items-center text-primary font-bold text-sm"><PlusIcon className="w-5 h-5 mr-1" /> Add Liability</button> </div> </div> );
    const renderExpenditure = () => ( <div className="space-y-8"> <div> <SectionHeader title="Educational Expenditure" subtitle="Sec 6.10 A" /> {eduExp.map(item => ( <ItemCard key={item.id} title={`Edu: ${item.name}`} onRemove={() => handleRemove(setEduExp, item.id)}> <FormInput label="Name & Relationship" value={item.name} onChange={(e:any) => handleChange(setEduExp, item.id, 'name', e.target.value)} /> <FormInput label="Amount (Nu.)" value={item.amount} onChange={(e:any) => handleChange(setEduExp, item.id, 'amount', e.target.value)} /> <FormInput label="School/College/Place" value={item.institution} onChange={(e:any) => handleChange(setEduExp, item.id, 'institution', e.target.value)} /> </ItemCard> ))} <button onClick={() => handleAdd(setEduExp, {name: '', amount: '', institution: ''})} className="flex items-center text-primary font-bold text-sm"><PlusIcon className="w-5 h-5 mr-1" /> Add Education Exp</button> </div> <div> <SectionHeader title="Other Expenditure" subtitle="Rental, Insurance, Loan Repayment, PF/GIS, etc (Sec 6.10 B)" /> {otherExp.map(item => ( <ItemCard key={item.id} title={item.category} onRemove={() => handleRemove(setOtherExp, item.id)}> <FormSelect label="Category" value={item.category} onChange={(e:any) => handleChange(setOtherExp, item.id, 'category', e.target.value)}> <option>Rental</option><option>Insurance</option><option>Loan Repayment</option><option>Mandatory Deduction (PF/GIS/TDS)</option><option>Travel</option><option>Vacation</option><option>Medical</option><option>Other</option> </FormSelect> <FormInput label="Details (Location/Company)" value={item.details} onChange={(e:any) => handleChange(setOtherExp, item.id, 'details', e.target.value)} /> <FormInput label="Amount (Nu.)" value={item.amount} onChange={(e:any) => handleChange(setOtherExp, item.id, 'amount', e.target.value)} /> </ItemCard> ))} <button onClick={() => handleAdd(setOtherExp, {category: 'Rental', details: '', amount: ''})} className="flex items-center text-primary font-bold text-sm"><PlusIcon className="w-5 h-5 mr-1" /> Add Other Exp</button> </div> </div> );
