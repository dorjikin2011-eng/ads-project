// pages/HoaProfilePage.tsx
// ------------------------------------------------------------
// EXACT COPY OF DECLARANT'S PROFILE PAGE
// Only changed: Component name and title
// ------------------------------------------------------------
...
const initialProfileData: ProfileData = {
  personal: {
    ...
    officialId: 'HOA-2023-001',
    dob: '1975-03-20',
    email: 'dorji.w@agency.gov.bt',
    phone: '17123456',
  },
  agency: {
  ...
  family: [
    { id: '1', name: 'Sonam Yangdon', relationship: 'Spouse', occupation: 'Bank Manager' },
    { id: '2', name: 'Tenzin Norbu', relationship: 'Son', occupation: 'University Student' },
    { id: '3', name: 'Dechen Pelmo', relationship: 'Daughter', occupation: 'High School Student' },
  ],
  assets: [],
  liabilities: [],
  expenditures: [],
...
const HoaProfilePage: React.FC<Props> = ({ profilePicture, setProfilePicture }) => {
  ...
  return (
    <div>
      {/* CHANGED: Updated title to indicate HoA */}
      <h1 className="text-3xl font-bold text-text-main mb-2">Your Profile - Head of Agency</h1>
      ...
      <div className="space-y-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 flex items-center space-x-6">
          ...
          <div>
            ...
            {/* CHANGED: Added HoA indicator */}
            <p className="text-sm text-primary font-medium">Head of Agency</p>
          </div>
        </div>
