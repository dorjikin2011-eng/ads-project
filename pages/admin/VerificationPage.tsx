            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 flex-1">
                <div className="lg:col-span-4 bg-white rounded-lg shadow p-4 h-fit">
                    ...
                    {filteredDeclarants.length > 0 ? (
                        ...
                        <p className="text-xs text-gray-400 italic p-2 text-center">No items in {queueFilter} queue.</p>
                    )}
                </div>
                        ...
                        <div className="bg-white rounded-lg shadow p-6">
                            ...
                            <div className="p-6 border-b">
                                ...
                                <div className="flex space-x-1 bg-gray-100 p-1 rounded-lg w-fit">
                                    {['Checklist', 'Assets', 'Financials', 'Documents'].map(tab => ( <button key={tab} onClick={() => setActiveTab(tab as any)} className={`px-4 py-2 text-sm font-medium rounded-md transition ${activeTab === tab ? 'bg-white text-primary shadow-sm' : 'text-gray-600 hover:text-gray-800'}`}> {tab} </button> ))}
                                </div>
                            </div>
